...
func (v *Vault) PeriodicallyRenewLeases(
	...
	databaseCredentialsLease *api.Secret,
...
func (v *Vault) renewLeases(
	...
	authTokenWatcher, err := v.client.NewLifetimeWatcher(&api.LifetimeWatcherInput{
		Secret: authToken,
	})
	...
	databaseCredentialsWatcher, err := v.client.NewLifetimeWatcher(&api.LifetimeWatcherInput{
